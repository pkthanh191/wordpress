...
# ------------------------------------------------------------------
#
#	Mingle to SP Import Definition File
#
# ------------------------------------------------------------------
...
function spi_collect_db_settings() {
	...
	<h3>Source Forum Data: Mingle</h3>
	<h4>To perform the import we require access to the source Mingle database. Please supply the following:</h4>
	<form name="mingle2spimport" method="post" action="<?php echo(admin_url()); ?>admin.php?page=sp-import/admin/spimport-setup.php&sys=mingle">

		<input type="hidden" id="s2" name="s2" value="s2" />
		<input type="hidden" id="selectsource" name="selectsource" value="mingle.php"
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"><label for="dbname">Mingle Database Name:</label></th>
			...
			<tr valign="top">
				<th scope="row"><label for="dbuser">Mingle Database User Name:</label></th>
			...
			<tr valign="top">
				<th scope="row"><label for="dbpass">Mingle Database Password:</label></th>
			...
			<tr valign="top">
				<th scope="row"><label for="dbhost">Mingle Database Host:</label></th>
			...
			<tr valign="top">
				<th scope="row"><label for="dbbasepfix">Mingle Table Prefix:</label></th>
